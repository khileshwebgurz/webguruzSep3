...
async function getPost(selectedCategory) {
  const res = await fetch(`${process.env.NEXTAUTH_URL}/api/getdata?limit=1000`); // This should return the array of posts directly
  ...
  const filteredPosts = data.filter((post) => {
    // Ensure post.acf and post.acf.list_all_category are defined before mapping
